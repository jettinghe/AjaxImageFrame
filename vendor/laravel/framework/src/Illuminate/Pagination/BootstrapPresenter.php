...
class BootstrapPresenter {
	...
	public function getPageRange($start, $end)
	{
		...
		for ($page = $start; $page <= $end; $page++)
		{
			...
			{
				$pages[] = '<li><a class="pure-button pure-button-active" href="#">'.$page.'</a></li>';
			}
			else
			{
	...
	public function getPrevious($text = '&laquo;')
	{
		...
		{
			return '<li class="disabled"><a class="pure-button prev" href="#">'.$text.'</a></li>';
		}
		else
		{
			$url = $this->paginator->getUrl($this->currentPage - 1);

			return '<li><a class="pure-button prev" href="'.$url.'">'.$text.'</a></li>';
		}
	}
	...
	public function getNext($text = '&raquo;')
	{
		...
		{
			return '<li class="disabled"><a class="pure-button next" href="#">'.$text.'</a></li>';
		}
		else
		{
			$url = $this->paginator->getUrl($this->currentPage + 1);

			return '<li><a class="pure-button next" href="'.$url.'">'.$text.'</a></li>';
		}
	}
	...
	public function getLink($page)
	{
		...
		return '<li><a class="pure-button" href="'.$url.'">'.$page.'</a></li>';
	}
